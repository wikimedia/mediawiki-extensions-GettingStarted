...
$messages['ca'] = array(
	...
	'gettingstarted-project-link' => '{{ns:Project}}:GettingStarted',
	'tag-gettingstarted_edit' => "via suggeriments d'edició de [[{{MediaWiki:gettingstarted-project-link}}|primers passos]]",
...
$messages['es'] = array(
	...
	'gettingstarted-project-link' => '{{ns:Project}}:PrimerosPasos',
	'tag-gettingstarted_edit' => 'vía [[{{MediaWiki:gettingstarted-project-link}}|Primeros pasos]] sugerencias de modificación',
	'tag-gettingstarted_edit-description' => 'Modificación hecha vía [[{{MediaWiki:gettingstarted-project-link}}|PrimerosPasos]] que sugiere tareas sencillas a los editores y les muestra cómo realizarlas.',
	...
	'gettingstarted-task-toolbar-no-suggested-page' => 'Lo sentimos. No hemos podido encontrar más páginas a mejorar en este momento. Puedes intentarlo de nuevo más tarde o buscar páginas sobre tus temas de interés.',
	...
	'gettingstarted-task-addlinks-toolbar-description' => 'Esta página puede necesitar más enlaces. Busca términos que tengan una página en {{SITENAME}}.',
	'gettingstarted-task-addlinks-toolbar-try-another-title' => 'Ir a una página aleatoria a que agregar enlaces',
	'guidedtour-tour-gettingstartedtasktoolbarintro-title' => 'Cómo empezar',
	'guidedtour-tour-gettingstartedtasktoolbarintro-description' => 'Empieza a revisar la página buscando posibles mejoras. Si te sientes abrumado no te preocupes, ¡no es necesario ser un experto en este tema! Si necesitas ayuda o prefieres probar con otra página, utiliza los enlaces de la barra superior.',
	'guidedtour-tour-gettingstartedtasktoolbar-ambox-title' => 'Ideas sobre qué hacer',
	'guidedtour-tour-gettingstartedtasktoolbar-ambox-description' => 'Estos carteles identifican problemas de la página. No es necesario solucionarlos todos. Resuélvelos únicamente hasta donde te sientas cómodo.',
	'guidedtour-tour-gettingstartedtasktoolbar-edit-article-title' => 'Pulsa en {{int:vector-view-edit}}',
	'guidedtour-tour-gettingstartedtasktoolbar-edit-article-description' => 'Puedes modificar la página haciendo click aquí.',
	'guidedtour-tour-gettingstartedtasktoolbar-edit-section-title' => 'Editar una sección',
	'guidedtour-tour-gettingstartedtasktoolbar-edit-section-description' => 'Para modificar una sección, haz click en el enlace azul  "{{int:editsection}}" de la zona superior de dicha sección.',
...
$messages['fa'] = array(
	...
	'gettingstarted-task-addlinks-toolbar-try-another-title' => 'رفتن به صفحهٔ اتفاقی که شما می‌توانید پیوندها را به آن اضافه کنید',
	'guidedtour-tour-gettingstartedtasktoolbarintro-title' => 'چگونگی شروع شدن',
	'guidedtour-tour-gettingstartedtasktoolbarintro-description' => 'فقط شروع به اسکن کردن از طریق صفحه‌ای کنید که به دنبال بهبود است. اگر احساس نگرانی کردید، نگران نباشید. شما نباید یک کارشناس در این موضوع باشید! اگر نیاز به کمک دارید یا می‌خواهید صفحهٔ دیگری را امتحان کنید، از پیوندهای بالای نوار استفاده کنید.',
	...
	'guidedtour-tour-gettingstartedtasktoolbar-edit-section-description' => 'اگر می‌خواهید یک بخش ویژه را ویرایش کنید، می‌توانید روی پیوند آبی «{{int:editsection}}» در بالای هر بخش کلیک کنید.',
...
$messages['ja'] = array(
	'gettingstarted' => 'はじめに',
	'gettingstarted-desc' => '新規利用者が編集者になるのを助けます',
	'gettingstarted-project-link' => '{{ns:Project}}:GettingStarted',
	'tag-gettingstarted_edit' => '[[{{MediaWiki:gettingstarted-project-link}}|Getting Started]] の提案による編集',
	'tag-gettingstarted_edit-description' => '[[{{MediaWiki:gettingstarted-project-link}}|GettingStarted]] （編集者に簡単なタスクを提案し、それを達成する方法を示すシステム）を通してなされた編集。',
	...
	'gettingstarted-task-toolbar-no-suggested-page' => '申し訳ありません。改善すべきページがこれ以上見つかりませんでした。しばらくあとでもう一度試すか、興味あるトピックについて検索してみてください。',
	'gettingstarted-task-copyedit-toolbar-description' => 'このページには修正可能な誤字や文法誤りがあるかもしれません。',
	'gettingstarted-task-copyedit-toolbar-try-another-title' => '校正すべきページをランダムに選んで表示する',
	'gettingstarted-task-clarify-toolbar-description' => 'このページは分かりにくかったり曖昧なところがあるかもしれません。明確にすることができないか考えてみてください。',
	'gettingstarted-task-clarify-toolbar-try-another-title' => '明確化すべきページをランダムに選んで表示する',
	'gettingstarted-task-addlinks-toolbar-description' => 'このページにはリンクがもっと必要かもしれません。{{SITENAME}}にページが存在する用語を見つけてください。',
	'gettingstarted-task-addlinks-toolbar-try-another-title' => 'リンクを追加すべきページをランダムに選んで表示する',
	'guidedtour-tour-gettingstartedtasktoolbarintro-title' => '最初の一歩を踏み出すには',
	'guidedtour-tour-gettingstartedtasktoolbarintro-description' => 'このページをざっと見て、改善できるところを探してみてください。自分には手に負えないとお思いでしたら、心配いりません。このトピックの専門家である必要はないのです。助けが必要だったり、別のページを試してみたい場合は、上部のバーにあるリンクをお使いください。',
	'guidedtour-tour-gettingstartedtasktoolbar-ambox-title' => 'やるべきことの提案',
	'guidedtour-tour-gettingstartedtasktoolbar-ambox-description' => 'これらのバナーはこのページにある問題を特定しています。すべてを解決する必要はありません。自分が苦なくできるものだけに集中してください。',
	...
	'gettingstarted-cta-leave' => 'いや、また今度にします',
);
...
$messages['ko'] = array(
	...
	'tag-gettingstarted_edit' => '편집 제안 [[{{MediaWiki:gettingstarted-project-link}}|시작하기]]를 통해',
...
$messages['lb'] = array(
	...
	'gettingstarted-task-toolbar-no-suggested-page' => 'Pardon. Leider konnte mir den Ament net méi Säit fannen déi verbessert misste ginn. Probéiert et méi spéit nach eng Kéier oder sicht déi Sujeten déi Iech interesséieren.',
	...
	'guidedtour-tour-gettingstartedtasktoolbarintro-description' => "Kuckt just iwwert d'Säit fir Verbesserungen. Wann Dir Iech iwwerfuerdert fillt da maacht Iech keng Gedanken. Dir musst keen Expert an deem Sujet sinn! Wann Dir Hëllef braucht oder eng aner Säit probéiere wëllt da benotzt d'Linken an der Läischt uewen.",
	'guidedtour-tour-gettingstartedtasktoolbar-ambox-title' => 'Iddie wat Dir maache kënnt',
	'guidedtour-tour-gettingstartedtasktoolbar-ambox-description' => 'Dës Banneren identifizéiere Problemer mat dëser Säit. Dir musst se net all léisen, konzentréiert Iech just op dat wat Dir Iech zoutraut.',
...
$messages['ml'] = array(
	...
	'tag-gettingstarted_edit' => '[[{{MediaWiki:gettingstarted-project-link}}|ആദ്യ ചുവടുകൾ]] തിരുത്തൽ നിർദ്ദേശങ്ങൾ വഴി',
...
$messages['or'] = array(
	...
	'gettingstarted-task-toolbar-try-another-text' => 'ଆଉ ଗୋଟେ ପୃଷ୍ଠା ଚେଷ୍ଟା କରନ୍ତୁ ►',
	'gettingstarted-task-toolbar-close-title' => 'ଏହି ଟୁଲବାରଟିକୁ ବନ୍ଦ କରିବେ',
	'gettingstarted-task-toolbar-no-suggested-page' => 'କ୍ଷମା କରିବେ ! ଆମେ ଏବେ ଅଧିକ ଉନ୍ନତ କରିହେଲା ଭଳି ପୃଷ୍ଠା ପାଉ ନାହୁଁ । କିଛି ସମୟ ପରେ ଚେଷ୍ଟା କରନ୍ତୁ କିମ୍ବା ଆପଣ ମନ ମୁତାବକ ଏକ ପୃଷ୍ଠା ଖୋଜନ୍ତୁ ।',
	'gettingstarted-task-copyedit-toolbar-description' => 'ଏହି ପୃଷ୍ଠାରେ ଥିବା ବନାନ କିମ୍ବା ବ୍ୟାକରଣଗତ ତୃଟିକୁ ଆପଣ ସୁଧାରି ପାରିବେ ।',
	...
	'guidedtour-tour-gettingstartedtasktoolbar-ambox-description' => 'ଏହି ବ୍ୟାନରଗୁଡିକ ଏହି ପୃଷ୍ଠାରେ ଥିବା ଅସୁବିଧା ଗୁଡିକୁ ଚିହ୍ନଟ କରିବ । ଆପଣଙ୍କୁ ସବୁ ବୁଝିବା ଦରକାର ନାହିଁ ଆପଣ ଯାହାକୁ ଠିକ ଭାବୁଛନ୍ତି ତାହାହିଁ ଦେଖନ୍ତୁ ।',
	'guidedtour-tour-gettingstartedtasktoolbar-edit-article-title' => 'କ୍ଲିକ {{int:vector-view-edit}}',
	'guidedtour-tour-gettingstartedtasktoolbar-edit-article-description' => 'ଆପଣ ଏଠାରେ କ୍ଲିକ କରି ପୁରା ପୃଷ୍ଠାଟିକୁ ସମ୍ପାଦନା କରିପାରିବେ',
	'guidedtour-tour-gettingstartedtasktoolbar-edit-section-title' => 'ଗୋଟିଏ ବିଭାଗକୁ ବଦଳାଇବେ',
	'guidedtour-tour-gettingstartedtasktoolbar-edit-section-description' => 'ଆପଣ ଏକ ନିର୍ଦ୍ଦିଷ୍ଟ ବିଭାଗଟିକୁ ବଦଳାଇବାକୁ ଚାହୁଁଥିଲେ ପ୍ରତ୍ୟେକ ବିଭାଗରେ ଥିବା ନୀଳ ରଙ୍ଗର "{{int:editsection}}"ରେ କ୍ଲିକ କରି କେବଳ ସେହି ବିଭାଗଟିକୁ ବଦଳାଇପାରିବେ ।',
	'guidedtour-tour-gettingstartedtasktoolbarve-click-save-title' => 'ଆପଣ ସମ୍ପାଦନା କରିପାରିବେ!',
	'guidedtour-tour-gettingstartedtasktoolbarve-click-save-description' => 'ଆପଣ ବର୍ତ୍ତମାନ ସମ୍ପାଦନା କରିପାରିବେ । ଲେଖିସାରିଲା ପରେ "{{int:visualeditor-toolbar-savedialog}}" ରେ କ୍ଲିକ କରି ଆପଣ ଦେଖି ପାରିବେ ଏବଂ ସାଇତି ପାରିବେ ।',
...
$messages['pl'] = array(
	...
	'gettingstarted-project-link' => 'Pierwsze kroki', # Fuzzy
...
$messages['pt'] = array(
	...
	'gettingstarted-project-link' => '{{ns:Project}}:GettingStarted',
	'tag-gettingstarted_edit' => 'através das sugestões de edição de [[{{MediaWiki:gettingstarted-project-link}}|primeiros passos]]',
	...
	'guidedtour-tour-gettingstartedtasktoolbarintro-title' => 'Como dar os primeiros passos',
...
$messages['pt-br'] = array(
	'gettingstarted' => 'Primeiros passos',
	'gettingstarted-desc' => 'Ajuda os novos usuários a se tornarem editores',
	'gettingstarted-project-link' => '{{ns:Project}}:PrimeirosPassos',
	'tag-gettingstarted_edit' => 'através das sugestões de edição de [[{{MediaWiki:gettingstarted-project-link}}|primeiros passos]]',
	'tag-gettingstarted_edit-description' => 'Edição feita pelo sistema de [[{{MediaWiki:gettingstarted-project-link}}|primeiros passos]], que sugere tarefas fáceis para editores e mostra a eles como completá-las.',
	...
	'gettingstarted-task-clarify-toolbar-try-another-title' => 'Vá a uma página aleatória que possa clarificar.',
	'gettingstarted-task-addlinks-toolbar-description' => 'Esta página pode necessitar de mais ligações. Procure por termos que possuam uma página na {{SITENAME}}.',
	'gettingstarted-task-addlinks-toolbar-try-another-title' => 'Vá a uma página aleatória na qual possa adicionar links',
	'guidedtour-tour-gettingstartedtasktoolbarintro-title' => 'Como iniciar',
	'guidedtour-tour-gettingstartedtasktoolbarintro-description' => 'Apenas comece varrendo a página e procurando por melhorias. Se se sentir sobrecarregado, não se preocupe. Você não precisa ser um especialista neste tópico! Se você precisar de ajuda ou quiser tentar outra página, use o link no topo da barra.',
	'guidedtour-tour-gettingstartedtasktoolbar-ambox-title' => 'Ideias sobre o que fazer',
	'guidedtour-tour-gettingstartedtasktoolbar-ambox-description' => 'Estes banners identificam problemas com esta página. Você não precisa corrigir todos, faça apenas o que está confortável em fazer.',
...
$messages['sco'] = array(
	...
	'tag-gettingstarted_edit-description' => 'Eedit dun bi waa o the [[{{MediaWiki:gettingstarted-project-link}}|GettinStairted]] system, that suggests easie tasks til eediters aen shaws thaim hou tae compleat thaim.',
...
$messages['sv'] = array(
	...
	'tag-gettingstarted_edit' => 'via redigeringsförslag för [[{{MediaWiki:gettingstarted-project-link}}|komma igång]]',
...
$messages['yi'] = array(
	...
	'tag-gettingstarted_edit' => 'דורך [[{{MediaWiki:gettingstarted-project-link}}|ערשטע שריט]] רעדאקטירן פארשלאגן',
...
$messages['zh-hans'] = array(
	...
	'tag-gettingstarted_edit' => '通过[[{{MediaWiki:gettingstarted-project-link}}|入门]]编辑建议',
...
$messages['zh-hant'] = array(
	...
	'tag-gettingstarted_edit' => '經由[[{{MediaWiki:gettingstarted-project-link}}|入門]]編輯建議',
