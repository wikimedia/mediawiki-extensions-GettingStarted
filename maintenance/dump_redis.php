...
class DumpRedisCategorySync extends \Maintenance {
	public function __construct() {
		parent::__construct();
		$this->addOption( 'all', 'Dump all keys with the prefix; can show keys from old naming ' .
			'schemes and other wikis (e.g. a different language). Will perform poorly in large ' .
